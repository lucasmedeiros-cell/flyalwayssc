...
import { NATIONAL, INTERNATIONAL, type Destination } from "@/lib/destinations";
...
// La data de destinos vive en lib/destinations (fuente única, sin "use client");
// se importa arriba y se re-exporta aquí por compatibilidad con quien importaba
// desde este módulo (p. ej. destinations-showcase).
export { NATIONAL, INTERNATIONAL, type Destination };
